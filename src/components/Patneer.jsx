    ...
    >
      <div className="text-white text-center space-y-5 p-5">
        ...
        <p className="w-full md:w-4xl mx-auto">
          ...
          with us by clicking the button below or call (406) 797-7989 to begin
        ...
        <div className="flex flex-row items-center justify-center gap-6 mt-4 flex-wrap">
          ...
          <a href="tel:+14067977989" className="flex flex-row items-center gap-2 px-3 py-2 rounded-full transition duration-200 hover:bg-gradient-to-r hover:from-[#F5BC24] hover:to-[#AF530E] hover:text-white">
